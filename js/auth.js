...
import { getAuth, createUserWithEmailAndPassword, signInWithEmailAndPassword, sendPasswordResetEmail, updateProfile } from 'https://www.gstatic.com/firebasejs/9.22.0/firebase-auth.js';
...
if($('signupForm')){
  $('signupForm').addEventListener('submit', async (e)=>{
    ...
    }catch(err){ console.error(err); show($('signupMsg'), err.message); }
  });
}
